            ...
            <div class="row">
                <div class="col-md-6 portfolio-item">
                    <a href="#portfolioModal1" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/social/pre1.png" class="img-responsive" alt="">
                    </a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <?php
                        ...
                        echo "<h2 class='section-heading'>" . $row['title'] . "</h2>";
                    ?>
                    <h3 class="section-subheading text-muted">Un retrato es una pintura o efigie principalmente de una persona. También se entiende por retrato la descripción de la figura o carácter, o sea, de las cualidades físicas o morales de una persona.</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-4">
                    <div class="team-member">
                        ...
                        <p class="text-muted">Retrato Individual</p>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="team-member">
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <p class="large text-muted">Contamos con la máxima experiencia para tomar los mejores retratos de la ciudad.</p>
                </div>
            </div>
        </div>
    </section>
