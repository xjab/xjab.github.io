        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 id="ache-dos" class='section-heading pantone'>Bodas</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 portfolio-item">
                    <img src="../img/social/bodaUno.jpg" class="img-responsive" alt="">
                    <div class="portfolio-caption">
                        <h4>Sesión informal</h4>
                    </div>
                </div>
                <div class="col-md-6 portfolio-item">
                    <img src="../img/social/bodaDos.jpg" class="img-responsive" alt="">
                    <div class="portfolio-caption">
                        <h4>Sesión formal</h4>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6 portfolio-item">
                    <img src="../img/social/bodaTres.jpg" class="img-responsive" alt="">
                    <div class="portfolio-caption">
                        <h4>Trash and Dress</h4>
                    </div>
                </div>
                <div class="col-md-6 portfolio-item">
                    <img src="../img/social/bodaCuatro.jpg" class="img-responsive" alt="">
                    <div class="portfolio-caption">
                        <h4>Secuencia</h4>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <h3>Paquete 1</h3>
                    <p>
                        Sesión fotográfica, informal en locación <br>
                        Sesión fotográfica, formal en estudio y/o locación <br>
                        Sesión familiar previa al civil <br>
                        Dos ampliaciones en marco y vidrio <br>
                        Retoque fotográfico <br>
                        Foto secuencia (civil, iglesia, recepción) <br>
                        DVD con todas las fotografías en alta resolución <br>
                        Foto álbum con 150 fotos impresas en 6x8 <br>
                        Photobook 8x10 con 20 páginas <br>
                    </p>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <p>
                        ...
                        Foto secuencia (civil, iglesia, recepción) <br>
                        DVD con todas las fotografías en alta resolución <br>
                        Foto álbum con 100 fotos impresas en 6x8 <br>
                    </p>
