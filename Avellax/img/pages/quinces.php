        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 id="ache-dos" class='section-heading pantone'>Quinceañeras</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 portfolio-item">
                    <img src="../img/social/quinceUno.jpg" class="img-responsive" alt="">
                    <div class="portfolio-caption">
                        <h4>Sesiones casuales</h4>
                    </div>
                </div>
                <div class="col-md-6 portfolio-item">
                    <img src="../img/social/quinceDos.jpg" class="img-responsive" alt="">
                    <div class="portfolio-caption">
                        <h4>Sesiones vestido</h4>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 portfolio-item">
                    <img src="../img/social/quinceTres.jpg" class="img-responsive" alt="">
                    <div class="portfolio-caption">
                        <h4>Secuencia</h4>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <h3>Paquete 1</h3>
                    <p>
                        Sesión fotográfica, informal en estudio o locación <br>
                        Sesión fotográfica, formal en estudio y/o locación con vestido <br>
                        Dos ampliaciones 11x14 en marco y vidrio <br>
                        Retoque fotográfico <br>
                        Foto secuencia (iglesia, recepción) <br>
                        CD con todas las fotografías en alta resolución <br>
                        Foto álbum con 100 fotos impresas en 6x8 <br>
                        Photobook 8x10 con 20 páginas. Pasta de lujo <br>
                    </p>
